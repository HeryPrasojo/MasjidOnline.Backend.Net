    ...
    ) : IUserUserBusiness
{
    ...
    public IVerifyRegisterBusiness VerifyRegister { get; } = new VerifyRegisterBusiness(_optionsMonitor, _authorizationBusiness, _service);
    public IVerifySetPasswordBusiness VerifySetPassword { get; } = new VerifySetPasswordBusiness(_optionsMonitor, _service);
}
