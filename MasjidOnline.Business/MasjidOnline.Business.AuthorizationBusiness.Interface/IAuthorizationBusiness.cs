...
public interface IAuthorizationBusiness
{
    ...
    Task AuthorizePermissionAsync(ISessionBusiness _sessionBusiness, IUserData _userData, bool infaqSetPaymentStatusExpired = false, bool userAddInternal = false);
}
