...
public interface IExpenditureRepository
{
    ...
    Task<ManyResult<ManyRecord>> GetManyAsync(ExpenditureStatus? status = null, ManyOrderBy getManyOrderBy = ManyOrderBy.None, OrderByDirection orderByDirection = default, int skip = 0, int take = 1);
