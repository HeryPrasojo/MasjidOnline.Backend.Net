...
public interface ISuccessRepository
{
    ...
    Task<ManyResult<ManyRecord>> GetManyAsync(SuccessStatus? status = null, ManyOrderBy getManyOrderBy = default, OrderByDirection orderByDirection = default, int skip = 0, int take = 1);
