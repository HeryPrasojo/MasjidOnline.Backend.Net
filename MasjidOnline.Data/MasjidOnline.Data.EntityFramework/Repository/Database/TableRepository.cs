...
public class TableRepository(DatabaseDataContext _databaseDataContext) : ITableRepository
{
    private readonly DbSet<Table> _dbSet = _databaseDataContext.Set<Table>();
