...
public class AccountancyDatabase(
    ...
    IAccountancyIdGenerator _accountancyIdGenerator) : Database(_accountancyDataContext), IAccountancyDatabase
{
    ...
    public IExpenditureRepository Expenditure => _userInternalPermissionLogRepository ??= new ExpenditureRepository(_accountancyDataContext, _accountancyIdGenerator);
}